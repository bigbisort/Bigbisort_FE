...
avocadoVarieties = [
    {
      name: 'Pusa Kesar',
      description: 'Pusa Kesar is a popular carrot variety known for its scarlet roots with a red central core.',
      image: 'assets/images/Prdpage/Carrot/pusa.jpeg' 
    },
    {
      name: 'Fuerte Avocado',
      description: 'This pear-shaped variety has smooth, thin, green skin that remains green even when ripe.',
      image: 'assets/images/Prdpage/Carrot/earlyn.webp'
    },
  
  ];

carrotBenefitsLeft = [
  { icon: 'fas fa-eye', text: 'Improves Vision' },
  { icon: 'fas fa-heart', text: 'Boosts Heart Health' },
  { icon: 'fas fa-shield-alt', text: 'Supports Immunity' }
];

carrotBenefitsRight = [
  { icon: 'fas fa-leaf', text: 'Rich in Antioxidants' },
  { icon: 'fas fa-carrot', text: 'Good for Digestion' },
  { icon: 'fas fa-bolt', text: 'Enhances Metabolism' }
];
